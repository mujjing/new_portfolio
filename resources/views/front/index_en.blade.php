...
<html>
            ...
            <div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
              ...
              <div class="flag-box">
                ...
                <ul class="flag-icons" style="padding-left: 0px;">
                  <li><a href="/kr"><img src="../../images/flag/korea.png" alt="korea"></a></li>
                  <li><a href="#"><img src="../../images/flag/english.png" alt="english"></a></li>
                  <li><a href="/"><img src="../../images/flag/japan.png" alt="japan"></a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-md-offset-0">
          <ul class="timeline">
            ...
            <li class="animate-box timeline-unverted">
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h3 class="timeline-title">株式会社Winas((C)Winas)</h3>
            ...
            <li class="timeline-inverted animate-box">
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h3 class="timeline-title">イーネット株式会社(e-net(C))</h3>
            ...
            <li class="timeline-inverted animate-box">
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h3 class="timeline-title">Navi</h3>
            ...
            <li class="animate-box timeline-unverted">
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h3 class="timeline-title">Working Holiday</h3>
                  <span class="company">in Austrailia - 2014</span>
                </div>
                <div class="timeline-body">
                  <p>I have a working holiday experience in Brisbane.</p>
                </div>
              </div>
            </li>
            </ul>
        ...
        <div class="row">
          <div class="col-md-6 text-center">
            <div class="feature-left">
              ...
              <div class="feature-copy">
                <h3>Web Devleop</h3>
                <p>I develop the web using larabel,<br>
                the representative framework of php</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 text-center">
            <div class="feature-left">
              ...
              <div class="feature-copy">
                <h3>iOS Develop</h3>
                <p>I develop the iOS using Swift</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div id="fh5co-skills" class="animate-box">
    <div class="container">
      ...
      <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
          <h2>Tools</h2>
          <p>tools which commonly used for development</p>
        </div>
        ...
        <div class="col-md-4 text-center col-padding animate-box">
          <a class="work" style="background-image: url(../images/tools/android.png);">
            <div class="desc">
              ...
              <span>android develop(self-taught)</span>
            </div>
          </a>
        </div>
      </div>
  ...
  <div id="fh5co-work" class="fh5co-bg-dark">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4 text-center col-padding animate-box">
          <a href="{{route('java_en')}}" class="work" style="background-image: url(../images/develop/java.png);" onclick="return check()">
            <div class="desc">
              <h3>Java</h3>
  ...
  <div id="fh5co-blog">
    <div class="container">
      <div class="row animate-box">
        <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
          <h2>My Goal</h2>
          <p>What's my goal from now on?</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
    ...
    <div class="choose animate-box" style="background-color: rgba(104, 210, 226, 0.9);">
      ...
      <input type="hidden" name="contact_number">
        <div class="row form-group">
          <div class="col-md-6">
            <input type="text" id="fname" name="to_name" class="form-control" placeholder="Your name" value="{{ old('to_name') }}" required />
          </div>
        </div>

        <div class="row form-group">
          <div class="col-md-12">
            <input type="text" id="email" name="user_email" class="form-control" placeholder="Your email address" value="{{ old('user_email') }}" required />
          </div>
        </div>

        <div class="row form-group">
          <div class="col-md-12">
            <input type="text" id="subject" name="title" class="form-control" placeholder="title of this message" value="{{ old('title') }}" required />
          </div>
        </div>

        <div class="row form-group">
          <div class="col-md-12">
            <textarea name="message" id="message" name="message" cols="30" rows="10" class="form-control" placeholder="Message" value="{{ old('message') }}" required></textarea>
          </div>
        </div>
            ...
            document.getElementById('contact-form').addEventListener('submit', function(event) {
                ...
                emailjs.sendForm('service_ket4kwj', 'template_njrpeim', this)
                    .then(function() {
                        ...
                        alert('failed. Please try to send mail again');
                    });
            });
        }
    </script>
